...
public class MediaImagesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        media=new MediaAdapter.Media("veera",R.drawable.picture);
        values.add(media);
        media=new MediaAdapter.Media("john cena",R.drawable.picture);
        values.add(media);
        media=new MediaAdapter.Media("undertaker",R.drawable.picture);
        values.add(media);
